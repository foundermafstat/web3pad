	...
	const features = [
		{
			...
			description: "All game results are stored on the Stacks blockchain with cryptographic verification",
			color: "text-blue-500"
		},
		{
			icon: Users,
			...
			<div className="container mx-auto px-4 py-12">
				...
				<div className="text-center mb-16">
					<div className="inline-flex items-center gap-2 bg-purple-500/10 border border-purple-500/20 rounded-full px-4 py-2 mb-6">
						<Block className="w-5 h-5 text-purple-400" />
					...
					<p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
						Experience the future of gaming where every achievement, every victory, and every moment 
						is permanently recorded on the blockchain. True ownership, verifiable results, and 
					...
					<div className="flex flex-wrap justify-center gap-4">
						...
						<Badge variant="outline" className="border-green-500/30 text-green-300 px-4 py-2">
						...
						<div className="grid lg:grid-cols-3 gap-8">
							...
							<div className="space-y-4">
								<div className="flex items-center gap-2 mb-4">
									...
									<h3 className="text-lg font-semibold text-white">Server Layer</h3>
								</div>
								<div className="space-y-2">
									<div className="flex items-center gap-2 text-sm text-gray-300">
							...
							<div className="space-y-4">
								<div className="flex items-center gap-2 mb-4">
									<Block className="w-5 h-5 text-purple-400" />
									<h3 className="text-lg font-semibold text-white">Blockchain Layer</h3>
								</div>
								<div className="space-y-2">
									<div className="flex items-center gap-2 text-sm text-gray-300">
					...
					<CardContent>
						<Tabs defaultValue="registry" className="w-full">
							...
							{contracts.map((contract, index) => (
								<TabsContent key={contract.name.toLowerCase().replace(' ', '-')} value={contract.name.toLowerCase().replace(' ', '-')} className="mt-6">
									<Card className="bg-slate-900/50 border-slate-600">
										...
										<CardContent>
											<div className="space-y-4">
												<div>
													<h4 className="text-sm font-medium text-gray-300 mb-2">Contract Address</h4>
													<div className="flex items-center gap-2 p-3 bg-slate-800/50 rounded-lg border border-slate-700">
														<code className="text-sm text-blue-300 flex-1">{contract.address}</code>
												...
												<div className="grid md:grid-cols-2 gap-4">
													...
													<div>
														<h4 className="text-sm font-medium text-gray-300 mb-2">Deployment Stats</h4>
														<div className="space-y-2">
															<div className="flex justify-between text-sm">
																<span className="text-gray-400">Lines of Code:</span>
																<span className="text-white">{contract.lines}</span>
															</div>
															<div className="flex justify-between text-sm">
																<span className="text-gray-400">Deployment Cost:</span>
																<span className="text-white">{contract.cost}</span>
															</div>
														</div>
													</div>
												</div>
					...
					<Card className="bg-gradient-to-r from-purple-900/50 to-blue-900/50 border-purple-500/30">
						<CardContent className="p-12">
							...
							<p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
								Join the future of gaming where every achievement is yours forever. 
								Connect your wallet and start earning real rewards.
							</p>

			...
			<div className="fixed inset-0 w-screen h-screen bg-gradient-to-br from-orange-900 to-red-900 flex flex-col items-center justify-center p-4 z-50">
				<div className="text-center max-w-md">
					...
					<p className="text-white/80 text-lg mb-6">
						Для игры требуется альбомный режим
					</p>
					...
					<div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
						<div className="flex items-center justify-center space-x-4 text-white/90">
							<div className="text-center">
								...
								<span className="text-sm">Портретный</span>
							</div>
							<div className="text-2xl">→</div>
							<div className="text-center">
								<div className="w-8 h-12 border-2 border-white rounded mb-2"></div>
								<span className="text-sm text-green-400 font-semibold">Альбомный</span>
							</div>
						</div>
					</div>

					<div className="mt-8 text-white/60 text-sm">
						<p>Игра оптимизирована для горизонтального экрана</p>
						<p className="mt-1">Поверните телефон влево или вправо</p>
					</div>

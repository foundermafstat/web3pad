    ...
    <Card className="w-full max-w-2xl">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Тест IPFS интеграции
        </CardTitle>
        <CardDescription>
          Проверьте работу IPFS с вашим API ключом Filebase
        </CardDescription>
      </CardHeader>
        ...
        {!uploadResult && !error && (
          <div className="text-center space-y-4">
            <p className="text-gray-600">
              Нажмите кнопку ниже для тестирования загрузки в IPFS
            </p>
            <Button
        ...
        {uploadResult && (
          <div className="space-y-4">
            <div className="flex items-center gap-2 text-green-800">
              ...
              <span className="font-medium">IPFS загрузка успешна!</span>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <h4 className="font-medium">Изображение</h4>

      ...
      const mockModules: GameModule[] = [
        {
          id: '1',
          name: 'Shooter Game',
          description: 'Классическая игра-шутер с системой наград',
          version: '1.0.0',
        ...
        },
        {
          id: '2',
          name: 'Tower Defense',
          description: 'Стратегическая игра защиты башни',
          version: '1.0.0',
  ...
  const handleRegisterModule = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(result.error || 'Ошибка регистрации модуля');
      }
    } catch (error) {
      setError('Произошла ошибка при регистрации модуля');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="bg-white rounded-lg shadow-lg">
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-gray-900">Реестр игровых модулей</h2>
            <p className="text-sm text-gray-600 mt-1">
              Управление и регистрация игровых контрактов
            </p>
          </div>
          <button
      ...
      <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600">Всего модулей</div>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600">Макс. игроков</div>
          </div>
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        {modules.length === 0 && !loading && (
          <div className="text-center py-8">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">Нет зарегистрированных модулей</h3>
            <p className="mt-1 text-sm text-gray-500">Начните с регистрации первого игрового модуля.</p>
          </div>
        )}
      </div>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900">Регистрация игрового модуля</h2>
                <button
